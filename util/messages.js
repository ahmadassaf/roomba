...
var messages =   {
	"en": {
		"error" : {
				...
				"invalidAPIResult"      : "This function has not been fullfilled successfully, try again later or the API doesn't support this feature",
				"parseError"            : "Erros Found - Check them out in errors.json",
				"profilingFailed"       : "The Profiling task failed for an un-known reason !\n",
			},
			"warning": {
			...
			"prompt" : {
				...
				separator                           ,
				{ "value" : "enrichDataset"         , "name" : "Enrich a specific dataset"}                    ,
				{ "value" : "enrichGroupDatasets"   , "name" : "Enrich all the datasets in a specific Group"}  ,
				{ "value" : "enrichAllDatasets"     , "name" : "Enrich all the datasets in this portal"}       ,
				separator                           ,
